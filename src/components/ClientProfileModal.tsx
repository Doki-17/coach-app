...
const fieldClass = "w-full border border-gray-300 rounded-lg px-3 py-2 outline-none focus:ring-2 focus:ring-blue-500";
        ...
        <div className="space-y-4">
          ...
          {bmi != null && (
            <p className="text-xs text-gray-500 -mt-2">
              BMI: <span className="font-medium text-gray-700">{bmi}</span>
            </p>
          )}
